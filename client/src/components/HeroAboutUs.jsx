  ...
  return (
    ...
    <div className='min-w-full max-w-full min-h-max max-h-max flex flex-row gap-x-16 relative'>
      <div className='flex-1 flex flex-col items-start justify-center gap-6 z-20'>
        ...
        <a href='#more' className='bg-gradient-to-r from-red-500 to-red-700 hover:from-red-500 hover:to-red-500 hover:shadow-lg rounded-lg flex flex-row items-center justify-center gap-7
        text-white font-bold max-w-max min-w-max  p-3 hover:text-white'><MoveDown size={20}/>I want to know more </a>
      </div>
